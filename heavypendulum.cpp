...
//Constructors
HeavyPendulum::HeavyPendulum() {}
HeavyPendulum::HeavyPendulum(std::string name, double mass, double length, double theta, double thetaDot, double theta2, double thetaDot2, double theta3, double thetaDot3, double z, double gamma)
:Pendulum(name, mass, length, theta, thetaDot, theta2, thetaDot2, theta3, thetaDot3, z, gamma) {
}
HeavyPendulum::~HeavyPendulum() {} //Destructor
...
void HeavyPendulum::SetValue(std::string VariableName, std::string Value) {
    double Value2;
