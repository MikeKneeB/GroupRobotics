...
number_actions = 2              # total number of discreet actions
min_action = -5                 # minimum discreet action, max taken to be -min.
initial_tau = 40.              # exploration, higher the more random the action selection. - 100.
tau_decay_rate = 1.03           # decay of tau, must be greater than 1. When = 1 constant tau. - 1.05
...
#dqn.load_weights('NRDumbbell.hf5') # Load weights from some previous training if want
