...
//angular velocity (thetaDot), position perpendicular to plane of motion (z) in metres and damping coefficient (gamma).
class Pendulum
{
public:
    //Default Constructor
    ...
    //Purely virtual methods used in derived classes
    virtual void setCharge(double)=0;
    virtual void SetValue(std::string VariableName, std::string Value)=0;
